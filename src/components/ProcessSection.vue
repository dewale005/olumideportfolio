    ...
    <div class="container">
      <div class="project__head text-center">
        ...
        <h2 class="fw-500" data-aos="fade-up" data-aos-duration="1000">
          ...
          <span class="d-block"> few steps </span>
        </h2>
      </div>
      <div class="row g-4">
        <div class="col-lg-4 col-md-6 col-sm-6" data-aos="flip-up" data-aos-duration="500">
          <div class="process__item">
            <h2 class="white mb-24">Concept</h2>
            <p class="mb-30 pra fz-18">
              Efficiently merging form, function, and user experience for optimal products.
            </p>
            <ul>
        ...
        <div class="col-lg-4 col-md-6 col-sm-6" data-aos="flip-up" data-aos-duration="500">
          <div class="process__item">
            <h2 class="white mb-24">Design</h2>
            <p class="mb-30 pra fz-18">
              Creating intuitive, aesthetic solutions for seamless user experiences and functionality.
            </p>
            <ul>
        ...
        <div class="col-lg-4 col-md-6 col-sm-6" data-aos="flip-up" data-aos-duration="500">
          <div class="process__item">
            <h2 class="white mb-24">Webflow</h2>
            <p class="mb-30 pra fz-18">
              Webflow: Streamlines web design, empowering creatives with visual coding capabilities.
            </p>
            <ul>
