          ...
          <div class="left__service">
            <div class="serial__adjust">
              ...
              <div class="cont">
                <h5>Designer</h5>
                <h2>
                  <a href="service.html"> Illustration Design </a>
                </h2>
              </div>
            </div>
            <p class="pra">
              Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat
              nulla pariatur. sunt in culpa qui officia deserunt mollit
            </p>
          </div>
          ...
          <div class="left__service">
            <div class="serial__adjust">
              ...
              <div class="cont">
                <h5>UI/UX Design</h5>
                <h2>
                  <a href="service.html"> Web UI/UX Design </a>
                </h2>
              </div>
            </div>
            <p class="pra">
          ...
          <div class="left__service">
            <div class="serial__adjust">
              ...
              <div class="cont">
                <h5>Web Design</h5>
                <h2>
                  <a href="service.html"> Application Design </a>
                </h2>
              </div>
            </div>
            <p class="pra">
