      ...
      <div class="row g-4 align-items-center">
        <div class="col-lg-7">
          <div class="pro__metting__content">
            ...
            <div class="about__contbox__item pb-30" data-aos="fade-up" data-aos-duration="1000">
              ...
              <span class="box">
                <span class="ptext fz-18 mb-1 d-block"> Email </span>
                <a href="mailto:olumideabioye@gmail.com"> olumideabioye@gmail.com </a>
              </span>
            </div>
            <div
              class="about__contbox__item pb-30 pt-30"
              data-aos="fade-up"
            ...
            >
              ...
              <span class="box">
                <span class="ptext fz-18 mb-1 d-block"> Location </span>
                <a href="javascript:void(0)"> England, United Kingdom </a>
              </span>
            </div>
          </div>
        </div>
        <div class="col-lg-5">
          <div class="pro__mettingthumb" data-aos="zoom-in" data-aos-duration="2000">
            <img src="/src/assets/img/project/504_597.png" alt="img" />
          </div>
        </div>
      </div>
    </div>
